...
export const Info = memo((props: InfoProps) => {
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M11 10C11.5523 10 12 10.4477 12 11V15C12 15.5523 11.5523 16 11 16C10.4477 16 10 15.5523 10 15V11C10 10.4477 10.4477 10 11 10Z" />
      <path d="M11 6C10.4477 6 10 6.44772 10 7C10 7.55228 10.4477 8 11 8H11.01C11.5623 8 12.01 7.55228 12.01 7C12.01 6.44772 11.5623 6 11.01 6H11Z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
